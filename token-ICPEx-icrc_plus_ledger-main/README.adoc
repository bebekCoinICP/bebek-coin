This readme and main documents in the folder are copied from the code that ICPEx opensourced.
I also added the BebekCoin-Canister-Code.txt where is the code from the BEBEK Coin canister deployed via the ICPEx. This is the canister: https://dashboard.internetcomputer.org/canister/m6e2t-iqaaa-aaaam-acrsa-cai

Please understand that I am not a developer and I did my best.
